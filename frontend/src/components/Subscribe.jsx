        ...
        <div className={styles.subscribeContainer}>
            ...
            <div className={styles.copyrightContainer}>
                ...
                <div className={styles.mediaContainer}>
                    <span className={styles.mediaIcon}><a href="#"><img src={fbIcon} alt='icon' /></a></span>
                    <span className={styles.mediaIcon}><a href="#"><img src={githubIcon} alt='icon' /></a></span>
                    <span className={styles.mediaIcon}><a href="#"><img src={igIcon} alt='icon' /></a></span>
                    <span className={styles.mediaIcon}><a href="#"><img src={inIcon} alt='icon' /></a></span>
                </div>
            </div>
        </div>
    );
